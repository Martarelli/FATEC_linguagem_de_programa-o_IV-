...
if (isset($_GET['enviar'])) {
  ...
  if (!empty($preco) && !empty($qtd) && 
      is_numeric($preco) && is_numeric($qtd) &&
      $preco >= 0 && $qtd >= 0) {
  
    $total = $preco * $qtd;
  
    $flag_msg = true; // Sucesso 
    $msg = "Cálculo efetuado com sucesso:<br />Valor Total = R$"; 
...
<div class="p-4 mb-4 bg-light">
  <h1 class="display-5">VALOR TOTAL</h1>
  <hr class="my-3">
  <p class="lead">Esse exemplo calcula o valor total.</p>
</div>
